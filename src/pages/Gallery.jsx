...
const Gallery = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] selection:bg-[#828a1c] selection:text-white">
        ...
        <div className="container mx-auto px-6 lg:px-20 relative z-10">
          <div className="max-w-5xl">
            <div className="flex items-center gap-4 mb-10">
              <div className="w-12 h-[1px] bg-[#828a1c]"></div>
              <span className="text-[#828a1c] text-[10px] font-black uppercase tracking-[1em]">Archive MMXXVI</span>
            </div>
            <h1 className="text-white text-7xl md:text-[12rem] font-serif italic leading-[0.75] tracking-tighter">
              Structural <br />
              <span className="text-[#828a1c] not-italic">Poetry</span>.
            </h1>
            ...
            <div className="flex gap-10 overflow-x-auto no-scrollbar w-full md:w-auto">
              {sectors.map((sect) => (
                ...
                >
                  {sect}
                  {sectFilter === sect && (
                    <span className="absolute bottom-0 left-0 w-full h-[2px] bg-[#828a1c]"></span>
                  )}
                </button>
              ))}
            </div>
            <div className="flex items-center gap-4">
               <Globe size={14} className="text-[#828a1c]" />
              ...
              {filteredProjects.map((project) => (
                <div key={project.id} className="relative break-inside-avoid group pt-4">
                  <Link to={`/project/${project.id}`} className="block">
                    ...
                    {/* Image - GrayScale removed, original color applied */}
                    <div className="relative overflow-hidden bg-white border border-black/5 transition-all duration-700 group-hover:shadow-2xl group-hover:shadow-black/5">
                      ...
                      <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-md px-4 py-2 flex items-center gap-3">
                          <Layers size={12} className="text-[#828a1c]" />
                    ...
                    <div className="mt-10 px-2 flex justify-between items-end">
                      <div>
                        ...
                        <h3 className="text-4xl font-serif italic text-black leading-none group-hover:text-[#828a1c] transition-colors">
                            {project.title}
                        </h3>
                      </div>
