                ...
                <div key={sector.category} className="border-b border-black/10">
                  ...
                  >
                    <div className="flex items-center gap-8">
                      <span className="font-mono text-[8px] font-medium text-black/40 group-hover:text-[#828a1c] transition-colors">0{index + 1}</span>
                    ...
                    {isOpen ? (
                      ...
                      <Plus size={18} strokeWidth={1} className="text-black group-hover:text-[#828a1c] transition-colors" />
                    )}
                  </button>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-3 pb-12 pl-12">
                          {sector.services.map((service, idx) => (
                            ...
                            >
                              ...
                              <ArrowUpRight size={12} className="opacity-0 group-hover:opacity-100 text-[#828a1c] transform translate-y-1 group-hover:translate-y-0 transition-all" />
                            </Link>
                          ))}
                        </div>
                      </motion.div>
