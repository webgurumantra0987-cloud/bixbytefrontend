      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-24">
          {stats.map((stat, i) => (
            ...
            >
              {/* Value with Brand Color */}
              <p className="text-[#828a1c] text-5xl md:text-7xl font-serif italic mb-3 tracking-tighter transition-transform duration-500 group-hover:scale-105">
                {stat.value}
              </p>
              ...
              <div className="space-y-1">
                ...
                {/* Contextual Sub-label for better Keyword indexing */}
        ...
        {/* SEO Contextual Paragraph (Low Opacity) */}
